		...
		<div class="container-fluid">
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					...
					<h1 class="text-uppercase">Administración de Vehiculos</h1> 
				...
				<div class="col-12">
					...
					<div class="card">
						...
						<div class="card-header">
							...
							<button class="btn btn-success btn-lg text-uppercase" data-bs-toggle="modal" data-bs-target="#modalAgregarVehiculo"><i class="fa fa-pen"></i> Agregar Vehiculo</button> 

                <a href="vistas/modulos/reportes/reporte-gral-vehiculo.php?vehiculosGral=vehiculosGral" class="btn btn-sm btn-tool" data-tooltip="tooltip" data-placement="top" data-original-title="Descarga Vehiculos (.xls)">

                    <button  type="button" class="btn btn-success btn-lg text-uppercase"><i class="fas fa-file-excel text-white"></i> Descargar Vehiculos</button>

                </a> 

               <button class="btn btn-success btn-lg btnGralReporteVehiculoXls text-uppercase"  data-tooltip="tooltip" data-original-title="Descargar Servicios General (.xlsx)"><i class="fa fa-download text-white"></i> Servicios Generales
               </button>
						...
						<div class="card-body">
							...
							<table id="tablaVehiculosGral" class="table table-bordered table-hover table-responsive tablaVehiculos" style="width: 100%;">
								...
								<tbody>
                                      ...
                                      <?php 
                                           ...
                                           /* $itemVeh = null;
                                            ...
                                            $respuestaVeh = ControladorVehiculos::ctrMostrarVehiculos($itemVeh, $valorVeh);
                                            ...
                                            foreach($respuestaVeh as $key => $value){
                                                  ...
                                                  echo  '<td class="text-center">'.$respuestaResponsable["responsable"].'</td>';
                                                        ...
                                                        $respuestaArea = ControladorAreasNegocios::ctrMostrarAreasNegocios($itemArea, $valorArea);

                                                        if(is_array($respuestaArea)){

                                                             echo  '<td class="text-center">'.$respuestaArea["area"].'</td>';
                                                        ...
                                                        $valorUsuario = $value["usuario_asignado_id"];

                                                        $respuestaCorresponsable = ControladorUsuarios::ctrMostrarUsuarios($itemUsuario, $valorUsuario);

                                                        if ($respuestaCorresponsable != 0) {

                                                          echo  '<td class="text-center">'.$respuestaCorresponsable["responsable"].'</td>';
                                                 ...
                                                 /*echo     '<td class="text-center">
                                                            ...
                                                            <button class="btn btn-warning btn-xs btnEditarVehiculo" idVehiculo="'.$value["idVehiculo"].'" data-bs-toggle="modal" data-bs-target="#modalEditarVehiculo" data-tooltip="tooltip" data-original-title="Editar"><i class="fa fa-pen"></i></button>

                                                            <button class="btn btn-danger btn-xs btnEliminarVehiculo" idVehiculo="'.$value["idVehiculo"].'"  data-tooltip="tooltip" data-original-title="Eliminar"><i class="fa fa-trash"></i></button>';*/

                                                            // <button class="btn btn-primary btn-xs btnReporteVehiculo" idVehiculo="'.$value["idVehiculo"].'"  data-tooltip="tooltip" data-original-title="Descargar .docx"><i class="fa fa-file-word text-white"></i></button>

                                                            // <button class="btn btn-success btn-xs btnReporteVehiculoXls" idVehiculo="'.$value["idVehiculo"].'"  data-tooltip="tooltip" data-original-title="Descargar .XLS"><i class="fa fa-file-excel text-white"></i></button>
  ...
  <div class="modal-dialog modal-xl modal-dialog-center">
    ...
    ======================================-->
          <div class="modal-header bg-success">
          	 ...
          	 <h4 class="modal-title text-uppercase">Nuevo Vehiculo </h4>
    ...
    ======================================-->
        ...
        <!--     			<div class="col-12 col-md-3">
                        ...
                        <div class="col-12 col-md-3 py-2">
                            ...
                            <label for="nuevaUnidaNegocioVehiculoId">Area | Asignación:</label>
                            ...
                            <div  class="input-group mb-2 mr-sm-2">
                                ...
                                <select name="nuevaUnidaNegocioVehiculo" id="nuevaUnidaNegocioVehiculoId" class="form-control" required="">
...
<!-- 
                                          ...
                                          <select name="nuevoResponsable" id="nuevoResponsableId" class="form-control selectpicker" data-live-search="true" required="">
                                ...
                                <div class="col-12 col-md-3 py-2">
                                    ...
                                    <label for="nuevoReCorresponsableId">Corresponsable:</label>
...
<!-- 
 ...
 -->
                                          ...
                                          <select name="nuevoCorresponsable" id="nuevoReCorresponsableId" class="form-control selectpicker" data-live-search="true" required="">
    ...
    ======================================-->
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-success text-uppercase"> Registrar Vehículo</button>
  ...
  <div class="modal-dialog modal-xl">
            ...
            <div class="box-body">
                  ...
                  <div class="row1">
                        ...
                        <div class="row col-12">
                            ...
                            <label for="editarUnidaNegocioVehiculoId">Area | Asignación:</label>
                            ...
                            <div  class="input-group mb-2 mr-sm-2">
                                ...
                                <select name="editarUnidaNegocioVehiculo" id="editarUnidaNegocioVehiculoId" class="form-control" required="">

                                <option value="" id="editarUnidaNegocioVehiculoId2"> -- SELECCIONAR AREA  -- </option>
                              ...
                              <div class="col-12 col-md-6 py-2">
                               ...
                               <div class="col-12 col-md-3 py-2">
                                    ...
                                    <label for="editarReCorresponsableId">Corresponsable:</label>

                                    <div  class="input-group mb-2 mr-sm-2">
                     
                                          <!-- <select name="editarCorresponsable" id="editarReCorresponsableId" class="form-control selectpicker" data-live-search="true" required=""> -->
                                            <select name="editarCorresponsable" id="editarReCorresponsableId" class="form-control" data-live-search="true" required="">

                                                <option value="" id="editarCorresponsableId2">-- Seleccionar Corresponsable --</option>
    ...
    ======================================-->
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-default pull-left text-uppercase" data-bs-dismiss="modal">Cerrar</button>
            <button type="submit" class="btn btn-success text-uppercase"> Actualizar Vehículo</button>
...
<div id="modalActualizarVehiculo" class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    ...
    ======================================-->
          <div class="modal-header bg-success">
             ...
             <h4 class="modal-title text-uppercase">Actualizacion de Foto</h4>
                      ...
                      <div class="card-body p-4">
                        ...
                        <div class="d-flex">
                          ...
                          <div class="flex-shrink-0">
                            ...
                            <img src="vistas/img/usuarios/default/anonymous.png" alt="Generic placeholder image" class="img-fluid img-thumbnail previsualizarVehiculo" style="width: 180px; border-radius: 10px;" />
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <h5 class="mb-1" id="imgVehiculo">.</h5>

                            <input type="file" class="editarFotoVehiculo" name="editarFotoVehiculo">
                            <input type="hidden" name="editarFotoId" id="editarFotoId" required="">
                            <input type="hidden" name="folioVehiculo" id="folioVehiculoId" required="">
                            <input type="hidden" name="numEco" id="numEcoId" required="">

                            <p class="mb-2 pb-1">

                            </p>

                            <div class="d-flex justify-content-center rounded-3 pb-2 mb-2 bg-body-tertiary">

                              <div>
                                 <input type="hidden" name="fotoActualVehiculo" id="fotoActualVehiculo">

                                <p class="small text-muted mb-1 text-center">Peso máximo de la foto 2 MB</p>
                            ...
                            <div class="d-flex pt-1">
                              ...
                              <button  type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-success flex-grow-1 text-uppercase">
    ...
    ======================================-->
          ...
          <?php 
              ...
              $actualizarFoto = new ControladorVehiculos();
              $actualizarFoto -> ctrActualizarFoto();
