				...
				<div class="col-12">
					...
					<div class="card">
						...
						<div class="card-header">
							...
							<!-- <button class="btn btn-info btn-lg text-uppercase" data-toggle="modal" data-target="#modalAgregarVehiculo"><i class="fa fa-pen"></i> Agregar Vehiculo</button>  -->
						...
						<div class="card-body">
							...
							<table id="tablaSolicitudesVehiculos" class="table table-bordered table-hover table-responsive tablaSolicitudesVehiculos" style="width: 100%;">
								...
								<tbody>
                                      ...
                                      <?php 
                                            ...
                                            $itemVeh = "usuario_asignado_id";
                                            $valorVeh = $_SESSION["idVehicular"];
                                            // echo $itemSesion = "id";
